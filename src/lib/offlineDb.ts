 ...
 *
 * Client-side offline database layer: Local SQLite-style storage
 * (better-sqlite3 / localStorage-backed browser fallback) and the
 * React hook (useDatabase / useOfflineDatabase) for persisting Repair
 * Intake entries offline. Server-side Postgres access lives in db.ts.
 */
